...
1. Метаданные (если можно извлечь из текста):
   Автор: имя (ник), роль/должность
   Уровень: простой/средний/продвинутый, ~X мин чтения

2. Суть статьи — 2-3 предложения, о чём статья и зачем её писали.

3. Основное содержание — самая большая часть. Разбей по логическим разделам.
...
4. Критический комментарий — твоя оценка по трём осям:
...
- Объём: от 2000 до 6000 символов. Не экономь на деталях
