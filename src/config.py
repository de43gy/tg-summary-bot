...
class Config:
    ...
    def from_env(cls) -> Config:
        ...
        return cls(
            ...
            custom_llm_api_url=os.environ.get("CUSTOM_LLM_API_URL"),
            custom_llm_api_key=os.environ.get("CUSTOM_LLM_API_KEY"),
            custom_llm_model=os.environ.get("CUSTOM_LLM_MODEL"),
            llm_request_delay=float(os.environ.get("LLM_REQUEST_DELAY", "2")),
            llm_max_retries=int(os.environ.get("LLM_MAX_RETRIES", "3")),
            db_path=os.environ.get("DB_PATH", "data/bot.db"),
            aggregator_enabled=os.environ.get("AGGREGATOR_ENABLED", "false").lower() == "true",
            aggregator_enabled_sources=enabled_sources,
            aggregator_schedule=os.environ.get("AGGREGATOR_SCHEDULE", "60"),
            aggregator_tone=os.environ.get("AGGREGATOR_TONE", "default"),
        )
